...
let filterSelectPrice = document.querySelector('.main__assort-select-price');
let filterSelectCategory = document.querySelector('.main__assort-select-category');
let filterSelectGender = document.querySelector('.main__assort-select-gender');
let filterSelectBrends = document.querySelector('.main__assort-select-brends');
let filterPrice = '';
let filterCategory = '';
let filterGender = '';
let filterBrends = '';
...
const getShoes = () =>{
    shoesList.innerHTML = '';
    fetch(url + `${filterPrice.length ? '_sort=price&_order=' + filterPrice + '&' : ''}${filterCategory.length ? 'category=' +filterCategory + '&' : ''}${filterGender.length ? 'gender=' + filterGender + '&' : ''}${filterBrends.length ? 'brend=' + filterBrends : ''}`)
...
filterSelectCategory.addEventListener('change', (e) =>{
    filterCategory = e.target.value;
    getShoes();
})

filterSelectGender.addEventListener('change', (e) =>{
    filterGender = e.target.value;
    getShoes();
})

filterSelectBrends.addEventListener('change', (e) =>{
    filterBrends = e.target.value;
    getShoes();
})
